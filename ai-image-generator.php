...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $response = $chatGPTService->getImageResponse($userInput);
    if ($response == '--') {
...
<script>
    function sendMessage() {
        ...
        chatLog.innerHTML += `<div class="d-flex justify-content-start placeholder-glow"><div class="placeholder message bot-message mb-2 p-2 rounded w-75"><span class="text-light p-2"><strong>AI generating image ...</strong></span></div></div>`;
        ...
        xhr.open('POST', 'ai-image-generator.php', true);
        ...
        xhr.onreadystatechange = function () {
            if (xhr.readyState === 4) {
                ...
                if (xhr.status === 200) {
                    ...
                    imageElement.src = response.response;
                    imageElement.classList.add('img-fluid'); // Make the image responsive
